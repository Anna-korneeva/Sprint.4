...
public class OrderTest2 extends BaseOrderTest {
    ...
    public OrderTest2 (String name, String surname, String address, String subway, String phoneNumber, String date, String rentalPeriod, String color, String comment) {
        this.name = name;
    ...
    public void orderPositiveTest2() {
        ...
        orderDownMainPage.openPage();

        // Скролим до нижней кнопки "Заказать"
        orderDownMainPage.scrollBottomButtonOrder();

        // Нажать на нижнюю кнопку "Заказать"
        orderDownMainPage.clickBottomButtonOrder();
